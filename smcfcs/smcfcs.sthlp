...
{pstd}Multiple imputation of covariates by substantive model compatible fully conditional specification{p_end}
{phang2}{cmd:smcfcs reg y x1 x1sq x2 x2sq, reg(x1 x2) passive(x1sq = x1^2 | x2sq = x2^2)}{p_end}
{phang2}{cmd:stset t_stcox}{p_end}
{phang2}{cmd:smcfcs stcox x_stcox xsq_stcox, reg(x_stcox) passive(xsq_stcox=x_stcox^2)}{p_end}
